...
#define FILL_RED 0.11f
#define FILL_BLUE 0.11f
#define FILL_GREEN 0.11f
...
- (void)drawRect:(NSRect)dirtyRect
{
    ...
    [[NSColor colorWithDeviceRed:FILL_RED green:FILL_GREEN blue:FILL_BLUE alpha:FILL_OPACITY] setFill];
    [path fill];
    ...
    NSRectFillUsingOperation(NSMakeRect(341, 11, 118, 28), NSCompositeClear);
}
